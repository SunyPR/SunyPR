...
I'm currently developing an e-commerce platform for a family accessories
business, integrating sales analytics and data automation.
...
Full pipeline with medallion architecture (Bronze → Silver → Gold)
using Python, Docker and MongoDB. Presented at UPY's high school expo.
Python Docker MongoDB ETL Medallion Architecture
### 🌦️ Weather ETL — Mérida
Automated pipeline that extracts weather data from the Open-Meteo API
for Mérida, orchestrated with Apache Airflow and TaskFlow API.
Apache Airflow Python Open-Meteo API PostgreSQL
---
## 📊 GitHub Stats
<div align="center">
![Suny's GitHub Stats](https://github-readme-stats.vercel.app/api?username=SunyPR&show_icons=true&theme=tokyonight&hide_border=true)
![Top Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=SunyPR&layout=compact&theme=tokyonight&hide_border=true)
</div>
---
## 📬 Contact
